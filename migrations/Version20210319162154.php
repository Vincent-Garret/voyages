 ...
 */
final class Version20210319162154 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE trip ADD category_id INT NOT NULL, ADD author VARCHAR(255) NOT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE trip DROP category_id, DROP author');
    }
}
